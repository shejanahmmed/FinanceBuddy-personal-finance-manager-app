...
@Database(entities = [AccountEntity::class, TransactionEntity::class, BudgetEntity::class, GoalEntity::class, PendingSmsTransactionEntity::class, PayeeEntity::class, PayeeAccountEntity::class, SmsSenderMappingEntity::class, LoanEntity::class, InvestmentEntity::class], version = 18, exportSchema = false)
